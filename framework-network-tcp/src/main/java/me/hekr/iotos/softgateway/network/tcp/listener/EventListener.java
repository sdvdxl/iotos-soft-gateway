...
public interface EventListener<T> {
   ...
   * @param reason 关闭连接原因
   */
  void onDisconnect(TcpServerConnectionContext<T> ctx, CloseReason reason);
   ...
   */
  void onHeartbeatTimeout(TcpServerConnectionContext<T> ctx, LocalDateTime lastOccurTime, int count);
